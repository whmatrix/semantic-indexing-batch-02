...
Index:   ./results/indexes/stackexchange_split2
Work:    ./results/work_dirs/stackexchange_split2
...
DATASET_DIR = Path("./datasets/stackexchange_split2")
INDEX_DIR = Path("./results/indexes/stackexchange_split2")
NVME_WORK_DIR = Path("./results/work_dirs/stackexchange_split2")
