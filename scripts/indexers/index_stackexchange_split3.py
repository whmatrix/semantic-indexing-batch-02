...
Index:   ./results/indexes/stackexchange_split3
Work:    ./results/work_dirs/stackexchange_split3
...
DATASET_DIR = Path("./datasets/stackexchange_split3")
INDEX_DIR = Path("./results/indexes/stackexchange_split3")
NVME_WORK_DIR = Path("./results/work_dirs/stackexchange_split3")
