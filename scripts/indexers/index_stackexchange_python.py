...
Index:   ./results/indexes/stackexchange_python
Work:    ./results/work_dirs/stackexchange_python
...
DATASET_DIR = Path("./datasets/stackexchange_python")
INDEX_DIR = Path("./results/indexes/stackexchange_python")
NVME_WORK_DIR = Path("./results/work_dirs/stackexchange_python")
